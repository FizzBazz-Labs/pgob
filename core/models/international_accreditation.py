...
class InternationalAccreditation(models.Model):
    ...
    country = models.ForeignKey(Country, on_delete=models.PROTECT, related_name='international_accreditations')
    ...
    allergies = models.ManyToManyField(Allergy, related_name='international_accreditations' ,blank=True)
    has_inmunizations = models.BooleanField(default=False)
    inmunizations = models.ManyToManyField(Inmunization, related_name='international_accreditations', blank=True)
    have_medical_history = models.BooleanField(default=False)
    medical_histories = models.ManyToManyField(MedicalHistory, related_name='international_accreditations', blank=True)
